...
const Counter = () => {
  ...
  // dispatch это метод, внутри которого выполняются действия,
  // связанные с изменением глобального состояния. Схожий принцип с хуком 
  // useState, где state тоже можно изменять
