...
const Counter: React.FC = () => {
  ...
  // у React есть большое число заранее описанных событий и html элементов
 // здесь мы описываем событие onChange, повешенное на элемент input
...
const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <>
      ...
      {/* decrement => number - 1 */}
      <button onClick={decrement10}> Decrement10 </button>{" "}
      {/* decrement => number - 1 */}
    </>
  );
};
